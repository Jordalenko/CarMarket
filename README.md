...
<hr>
Car_Zombie is a full stack e-commerce project allowing users to post listings with their vehicle for sale. The project was built using the Django framework for the backend and HTML, CSS, Bootstrap and JavaScript on the frontend. Car_Zombie allows the users to create an account and perform CRUD functionality on their profile and listings. This project was created as part of Code Institute's Level 5 Web Development course.

![Car_Zombie Image](./assets/)
...
6. As a user I want to be able to register an account so that I can have access to all functionality of Car_Zombie.
...
11. As a registered user I want to be able to delete my profile and all my listings if I do not wish to use the services of Car_Zombie.
...
- Users can register an account, providing access to all functionality of Car_Zombie.
...
## Features
### Navbar
The navbar is a component that is present on all pages. It was created using Bootstrap and is fully responsive. The Car_Zombie logo which serves as a link to the homepage is located on the left side on the navbar. On the right are the nav links which allow the user to easily navigate through the website from any point. If the user is not authenticated the links displayed are Home, Listings, and Login/Signup.
...
![nav logged out](./assets/readme-images/features/nav-logged-out.PNG)
 ...
 ### Footer
 The footer consists of information about Car_Zombie and their contact details. To help the users connect with Car_Zombie there are icons with links to social media which open in a new tab. 
...
|Bug|Status|
| ---| ---|
|[BUG: Deployment error #30](https://github.com/Dayana-N/Car_Zombie-PP4/issues/30#issue-1816808909)|Closed|
|[BUG: Update user profile form images #33](https://github.com/Dayana-N/Car_Zombie-PP4/issues/33#issue-1848255025)|Closed|
|[BUG: Create listing form not displaying correctly #34](https://github.com/Dayana-N/Car_Zombie-PP4/issues/34#issue-1857900988)|Closed|
|[BUG: Error when the user deletes their default image #37](https://github.com/Dayana-N/Car_Zombie-PP4/issues/37#issue-1867812729)|Closed|
|[BUG: Wrong time since on listings #38](https://github.com/Dayana-N/Car_Zombie-PP4/issues/38#issue-1868276351)|Closed|
|[BUG: Page error when the user tries to delete their profile #39](https://github.com/Dayana-N/Car_Zombie-PP4/issues/39#issue-1868283130)|Closed|
|[BUG: Issue when sending email to listing owner #40](https://github.com/Dayana-N/Car_Zombie-PP4/issues/40#issue-1868292453)|Closed|
|[BUG: Search results pagination #41](https://github.com/Dayana-N/Car_Zombie-PP4/issues/41#issue-1868485937)|Closed|
|[BUG: Dynamic update on profile page causes issue when redirected back to the page #42](https://github.com/Dayana-N/Car_Zombie-PP4/issues/42#issue-1868626287)|Open|
...
### Creating a fork
1. Navigate to the [repository](https://github.com/Dayana-N/Car_Zombie-PP4)
